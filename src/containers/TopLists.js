  ...
  return (
      <div className="toplists container">
        <Row>
          <Col md={12}>
            <h2>Top Funders</h2>
            <p className="size-medium font-weight-light">These organizations gave the most. Public funders are often government agencies, while private funders are often philanthropic organizations who file Form 990-PF.</p>
          </Col>
        </Row>
        <Row>
          <Col md={6}>
        ...
        <Row>
          <Col md={12}>
            ...
            <p className="size-medium font-weight-light">These organizations received the most. Public recipients are often government agencies and private recipients are often registered nonprofit organizations. Some recipients may be ranked highly because they act as "pass through" organizations for grants between the federal government or other endowments and local recipients.</p>
          </Col>
        </Row>
        <Row>
          <Col md={6}>
